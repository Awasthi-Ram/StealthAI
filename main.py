...
class StealthAIApp:
    ...
    def register_hotkeys(self):
        ...
        keyboard.add_hotkey(self.config.get("hotkey_scroll_up", "ctrl+shift+up"), lambda: self.signals.trigger_scroll_up.emit())
        keyboard.add_hotkey(self.config.get("hotkey_scroll_down", "ctrl+shift+down"), lambda: self.signals.trigger_scroll_down.emit())
        keyboard.add_hotkey(self.config.get("hotkey_move_up", "alt+shift+up"), lambda: self.signals.trigger_move_up.emit())
        keyboard.add_hotkey(self.config.get("hotkey_move_down", "alt+shift+down"), lambda: self.signals.trigger_move_down.emit())
        keyboard.add_hotkey(self.config.get("hotkey_move_left", "alt+shift+left"), lambda: self.signals.trigger_move_left.emit())
        keyboard.add_hotkey(self.config.get("hotkey_move_right", "alt+shift+right"), lambda: self.signals.trigger_move_right.emit())
        keyboard.add_hotkey(self.config.get("hotkey_capture_add", "ctrl+shift+4"), lambda: self.signals.trigger_capture_add.emit())
        keyboard.add_hotkey(self.config.get("hotkey_process_buffer", "ctrl+shift+5"), lambda: self.signals.trigger_process_buffer.emit())
